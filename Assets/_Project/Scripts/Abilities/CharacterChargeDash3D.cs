...
{
    /// <summary>
    /// Dash ability that deals damage to all enemies in path
    /// 
    /// Animation parameters:
    /// ChargeDashing (bool) - true during charge dash
    ...
    public class CharacterChargeDash3D : CharacterAbility
    {
        ...
        [Tooltip("Detection frequency (0 = every frame)")]
        ...
        protected virtual void StartDash()
        {
            ...
            _detectionCoroutine = StartCoroutine(DetectAndDamageCoroutine());
        }
        ...
        protected virtual IEnumerator DetectAndDamageCoroutine()
        {
            WaitForSeconds wait = DetectionInterval > 0 
        ...
        protected virtual void DetectAndDamage()
        {
            ...
            foreach (Collider hit in hits)
            {
                ...
                if (DamageOncePerTarget && _damagedTargets.Contains(hit.gameObject))
                {
                    continue;
                }
        ...
        public override void UpdateAnimator()
        {
            ...
            MMAnimatorExtensions.UpdateAnimatorBool(
                _animator, 
                _chargeDashStartedParameter, 
                _dashStartedThisFrame, 
                _character._animatorParameters, 
                _character.RunAnimatorSanityChecks
            );
