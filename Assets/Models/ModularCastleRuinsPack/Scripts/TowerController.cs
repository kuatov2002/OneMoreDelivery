...
public class TowerController : MonoBehaviour
{
    ...
    public List<GameObject> middlePrefab;
    ...
    public void addFloor(int increment){
        ...
        GameObject newObj = Instantiate(middlePrefab[Random.Range(0, middlePrefab.Count)], new Vector3(0,baseSize+(n*3),0),transform.rotation, transform);
        newObj.name = "floor"+n;
        if(randomRotation){
            newObj.transform.localRotation = Quaternion.Euler(0,Random.Range(0,360.0f),0);
        }
